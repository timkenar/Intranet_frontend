...
const Login = () => {
  ...
  <div className="container mx-auto mt-8 p-4"> 
    <div className="bg-white shadow-lg rounded-lg max-w-2xl mx-auto p-5">     
      {error && <p>{error}</p>}
      <form onSubmit={handleSubmit} class="space-y-4 font-[sans-serif] text-[#333] max-w-md mx-auto">
...
//       <div className=' bg-white rounded-md shadow-md max-w-md px-8 py-6 w-full'>
